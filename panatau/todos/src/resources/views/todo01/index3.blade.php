...
@section('scriptjs-bottom')
    <script src="{{ asset($panatauPublicPath.'/jQuery-2.1.4.min.js') }}"></script>
    <script src="{{ asset($panatauPublicPath.'/main03.js') }}"></script>
@endsection
@section('content')
<div id="app">
    <div class="container">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="Apa yang harus dilakukan" v-model="todo.judul">
                        </div>
                        <div class="form-group">
